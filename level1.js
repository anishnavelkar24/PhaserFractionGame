...
create:function(game)
    {
       ...
       //_this.selectedAns = "";
        ...
        _this.topbar=_this.add.sprite(0,0,'F2_5topbar');
        _this.topbar.scale.setTo(1,1.1);
        
        _this.backbtn = _this.add.button(10,7,'F2_5backbtn',function(){
            _this.clickSound = _this.add.audio('ClickSound');
            _this.clickSound.play();
            _this.state.start('grade1levelSelectionScreen',true,false);
            console.log("here");},_this,0,1,2);

        _this.speaker = _this.add.button(620,9,'F2_5speaker',function(){
            _this.clickSound = _this.add.audio('ClickSound');
            _this.clickSound.play();
            _this.getVoice();
        },_this);
        
        _this.timebg=_this.add.sprite(320,9,'F2_5timerbg');
  ...
  updateTimer:function() {
    ...
    generateStarsForTheScene:function(count)
	{
		...
		for (var i = 0; i < count; i++)
		{
			...
			_this.starsGroup.create(_this.world.centerX, 15, 'F2_5starAnim');
			for(var j =0;j<i;j++)
			{
...
//         },_this);
 ...
 getVoice:function(){
        ...
        switch(_this.qArrays[_this.no11])
        {
            ...
            case 8:
            case 9:
            case 10:if(selctedLang.selectedlanguage =="English")
                    {
                         _this.src.setAttribute("src", "questionSounds/2.5/English/nsf2.5E.mp3");
                    }
                    else if(selctedLang.selectedlanguage =="Hindi")
                    {
                         _this.src.setAttribute("src", "questionSounds/2.5/Hindi/nsf2.5H.mp3");
                    }
                    else if(selctedLang.selectedlanguage =="Kannada")
                    {
                         _this.src.setAttribute("src", "questionSounds/2.5/Kannada/nsf2.5K.mp3");
                    }
                    else if(selctedLang.selectedlanguage =="Gujarati")
                    {
                         _this.src.setAttribute("src", "questionSounds/2.5/Gujarati/nsf2.5G.mp3");
                    }
                  else
                    {
                        _this.src.setAttribute("src", "questionSounds/2.5/Odiya/nsf2.5O.mp3");
